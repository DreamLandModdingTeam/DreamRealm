...
*/
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6,
            ...
            for (k1 = l - short1; k1 <= (l + short1); ++k1){
                ...
                for (int l1 = i1 - short1; l1 <= (i1 + short1); ++l1){
                    ...
                    for (int i2 = worldServerInstance.getActualHeight() - 1; i2 >= 0; --i2){
                        if (worldServerInstance.getBlockId(k1, i2, l1) == Block.portal.blockID){
                            while (worldServerInstance.getBlockId(k1, i2 - 1, l1) == Block.portal.blockID){
                                --i2;
                            }
        ...
        if (d3 >= 0.0D){
            if (flag){
                field_85191_c.add(j1, new PortalPosition(this, i, j, k,
            ...
            if (worldServerInstance.getBlockId(i - 1, j, k) == Block.portal.blockID){
                j2 = 2;
            }
            ...
            if (worldServerInstance.getBlockId(i, j, k - 1) == Block.portal.blockID){
                j2 = 3;
            }
        ...
        for (k2 = 0; k2 < 4; ++k2){
            for (i3 = 0; i3 < 4; ++i3){
                for (l2 = -1; l2 < 4; ++l2){
                    ...
                    worldServerInstance.setBlock(k3, j3, i4,
                            flag ? Block.obsidian.blockID : Block.portal.blockID, 0,
                            2);
                }
            }
