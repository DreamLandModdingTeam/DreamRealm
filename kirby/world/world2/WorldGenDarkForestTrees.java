...
public class WorldGenDarkForestTrees extends WorldGenerator
{
    ...
    public WorldGenDarkForestTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenDarkForestTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
        field_48202_a = par2;
        field_48201_c = par3;
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        for (int l1 = 0; l1 < i; l1++)
        {
            ...
            setBlockAndMetadata(par1World, par3, par4 + l1, par5, 	Block.wood.blockID, 1);
