...
public class TeleporterDrakForest extends Teleporter
{
    ...
    public TeleporterDrakForest(WorldServer par1WorldServer)
    {
	...
	public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == Block.bed.blockID)
            {
                j2 = 2;
            }
    ...
    public void func_85189_a(long lastUpdateTime)
    {
        if (lastUpdateTime % 100L == 0L)
        {
            @SuppressWarnings("rawtypes")
			Iterator iterator = this.field_85190_d.iterator();
            long j = lastUpdateTime - 600L;
