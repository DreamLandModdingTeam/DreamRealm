...
public class EntityDog extends EntityTameable
{
    ...
    public EntityDog(World par1World)
    {
        super(par1World);
  ...
  //      this.tasks.addTask(8, new EntityAIBeg(this, 8.0F));
     ...
     */
    public EntityDog spawnBabyAnimal(EntityAgeable par1EntityAgeable)
    {
        EntityDog entitywolf = new EntityDog(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityDog))
        {
            return false;
        }
        else
        {
            EntityDog entitywolf = (EntityDog)par1EntityAnimal;
